...
TArray<FParkMapPin> ASlideGameMode::StatusPins() const {
 static const TCHAR* Future[]={TEXT("PLEASE HOLD"),TEXT("ROTOR QUEUED"),TEXT("CLEVERLY IDLE"),TEXT("SNACK QUEUED"),TEXT("PILE PENDING"),TEXT("TOUR BUFFERING"),TEXT("SALAD BUFFERING")};
 static const TCHAR* Next[]={TEXT("LIFE FINDS A WAY"),TEXT("GET TO CHOPPA"),TEXT("HOLD YOUR BUTTS"),TEXT("FEED THE LAWYER"),TEXT("CHECK THE PILE"),TEXT("SPARE NO CACHE"),TEXT("LEAF ME ALONE")};
 static const TCHAR* Past[]={TEXT("MERGE GATE OPEN"),TEXT("FLIGHT COMMITTED"),TEXT("CLEVER GIRL"),TEXT("LAWYER CONSUMED"),TEXT("PILE VERIFIED"),TEXT("CACHE SPARED"),TEXT("TREE DOWNLOADED")};
