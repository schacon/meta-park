...
TArray<FParkMapPin> ASlideGameMode::StatusPins() const {
 static const TCHAR* Future[]={TEXT("PLEASE HOLD"),TEXT("SALAD BUFFERING"),TEXT("SNACK QUEUED"),TEXT("PILE PENDING"),TEXT("CLEVERLY IDLE"),TEXT("TOUR BUFFERING"),TEXT("ROTOR QUEUED")};
 static const TCHAR* Next[]={TEXT("LIFE FINDS A WAY"),TEXT("LEAF ME ALONE"),TEXT("FEED THE LAWYER"),TEXT("CHECK THE PILE"),TEXT("HOLD YOUR BUTTS"),TEXT("SPARE NO CACHE"),TEXT("GET TO CHOPPA")};
 static const TCHAR* Past[]={TEXT("MERGE GATE OPEN"),TEXT("TREE DOWNLOADED"),TEXT("LAWYER CONSUMED"),TEXT("PILE VERIFIED"),TEXT("CLEVER GIRL"),TEXT("CACHE SPARED"),TEXT("FLIGHT COMMITTED")};
